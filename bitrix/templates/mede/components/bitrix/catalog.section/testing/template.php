...
<?
if($_REQUEST["PAGEN"]=="0") require($_SERVER["DOCUMENT_ROOT"]."/include/tests/".$_REQUEST["TID"]."/end.php");
else require($_SERVER["DOCUMENT_ROOT"]."/include/tests/".$_REQUEST["TID"]."/out_vote.php");
?>
