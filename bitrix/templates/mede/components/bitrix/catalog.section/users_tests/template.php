...
<?foreach($arResult["ITEMS"] as $cell=>$arElement):?>
 ...
 <?if(strlen($arElement["DISPLAY_PROPERTIES"]["LINK"]["VALUE"])):?>
   <?$detail_url = str_replace( "#LINK#", $arElement["DISPLAY_PROPERTIES"]["LINK"]["VALUE"], $arElement["DETAIL_PAGE_URL"]);?>

   <a href="<?=$detail_url?>"><?=$arElement["NAME"]?></a><br />
 <?else:?>
                              <?=$arElement["NAME"]?>&nbsp(пройден)<br />
 <?endif?>
